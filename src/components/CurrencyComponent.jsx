...
const CurrencyComponent = () => {
  ...
  switch (currency) {
    ...
    case "JPY":
      ...
      break;
    case "KES":
      symbolPath = "Ksh"; // Kenyan shilling
      break;
    case "KGS":
      symbolPath = "с"; // Kyrgyzstani som
      break;
    case "KHR":
      symbolPath = "៛"; // Cambodian riel
      break;
    case "KID":
      symbolPath = "$"; // Kiribati dollar
      break;
    case "KMF":
      symbolPath = "CF"; // Comorian franc
      break;
    case "KPW":
      symbolPath = "₩"; // North Korean won
      break;
    case "KRW":
      symbolPath = "₩"; // South Korean won
      break;
    case "KWD":
      symbolPath = "د.ك"; // Kuwaiti dinar
      break;
    case "KYD":
      symbolPath = "$"; // Cayman Islands dollar
      break;
    case "KZT":
      symbolPath = "₸"; // Kazakhstani tenge
      break;
    case "LAK":
      symbolPath = "₭"; // Lao kip
      break;
    case "LBP":
      symbolPath = "ل.ل"; // Lebanese pound
      break;
    case "LKR":
      symbolPath = "රු"; // Sri Lankan rupee
      break;
    case "LRD":
      symbolPath = "$"; // Liberian dollar
      break;
    case "LSL":
      symbolPath = "LSL"; // Lesotho loti
      break;
    case "LYD":
      symbolPath = "ل.د"; // Libyan dinar
      break;
    case "MAD":
      symbolPath = "د.م."; // Moroccan dirham
      break;
    case "MDL":
      symbolPath = "MDL"; // Moldovan leu
      break;
    case "MGA":
      symbolPath = "MGA"; // Malagasy ariary
      break;
    case "MKD":
      symbolPath = "MKD"; // Macedonian denar
      break;
    case "MMK":
      symbolPath = "K"; // Burmese kyat
      break;
    case "MNT":
      symbolPath = "₮"; // Mongolian tögrög
      break;
    case "MOP":
      symbolPath = "MOP$"; // Macanese pataca
      break;
    case "MRU":
      symbolPath = "UM"; // Mauritanian ouguiya
      break;
    case "MUR":
      symbolPath = "₨"; // Mauritian rupee
      break;
    case "MVR":
      symbolPath = "Rf"; // Maldivian rufiyaa
      break;
    case "MWK":
      symbolPath = "MK"; // Malawian kwacha
      break;
    case "MXN":
      symbolPath = "$"; // Mexican peso
      break;
    case "MYR":
      symbolPath = "RM"; // Malaysian ringgit
      break;
    case "MZN":
      symbolPath = "MT"; // Mozambican metical
      break;
    case "NAD":
      symbolPath = "$"; // Namibian dollar
      break;
    case "NGN":
      symbolPath = "₦"; // Nigerian naira
      break;
    case "NIO":
      symbolPath = "C$"; // Nicaraguan córdoba
      break;
    case "NOK":
      symbolPath = "kr"; // Norwegian krone
      break;
    case "NPR":
      symbolPath = "रू"; // Nepalese rupee
      break;

    case "NZD":
      symbolPath = "$"; // New Zealand dollar
      break;
    case "OMR":
      symbolPath = "ر.ع."; // Omani rial
      break;
    case "PAB":
      symbolPath = "B/."; // Panamanian balboa
      break;
    case "PEN":
      symbolPath = "S/"; // Peruvian sol
      break;
    case "PGK":
      symbolPath = "K"; // Papua New Guinean kina
      break;
    case "PHP":
      symbolPath = "₱"; // Philippine peso
      break;
    case "PKR":
      symbolPath = "₨"; // Pakistani rupee
      break;
    case "PLN":
      symbolPath = "zł"; // Polish złoty
      break;
    case "PRB":
      symbolPath = "р."; // Transnistrian ruble
      break;
    case "PYG":
      symbolPath = "₲"; // Paraguayan guaraní
      break;
    case "QAR":
      symbolPath = "ر.ق"; // Qatari riyal
      break;
    case "RON":
      symbolPath = "lei"; // Romanian leu
      break;
    case "RSD":
      symbolPath = "дин"; // Serbian dinar
      break;
    case "RUB":
      symbolPath = "₽"; // Russian ruble
      break;
    case "RWF":
      symbolPath = "FR"; // Rwandan franc
      break;
    case "SAR":
      symbolPath = "ر.س"; // Saudi riyal
      break;
    case "SEK":
      symbolPath = "kr"; // Swedish krona
      break;
    case "SGD":
      symbolPath = "$"; // Singapore dollar
      break;
    case "SHP":
      symbolPath = "£"; // Saint Helena pound
      break;
    case "SLL":
      symbolPath = "Le"; // Sierra Leonean leone
      break;
    case "SLS":
      symbolPath = "SLS"; // Somaliland shilling
      break;
    case "SOS":
      symbolPath = "Sh"; // Somali shilling
      break;
    case "SRD":
      symbolPath = "$"; // Surinamese dollar
      break;
    case "SSP":
      symbolPath = "£"; // South Sudanese pound
      break;
    case "STN":
      symbolPath = "Db"; // São Tomé and Príncipe dobra
      break;
    case "SYP":
      symbolPath = "£"; // Syrian pound
      break;
    case "SZL":
      symbolPath = "L"; // Swazi lilangeni
      break;
    case "THB":
    ...
    case "TJS":
      symbolPath = "ЅМ"; // Tajikistani somoni
      break;
    case "TMT":
      symbolPath = "TMT"; // Turkmenistan manat
      break;
    case "TND":
      symbolPath = "د.ت"; // Tunisian dinar
      break;
    case "TOP":
      symbolPath = "T$"; // Tongan paʻanga
      break;
    case "TRY":
      symbolPath = "₺"; // Turkish lira
      break;
    case "TTD":
      symbolPath = "$"; // Trinidad and Tobago dollar
      break;
    case "TVD":
      symbolPath = "$"; // Tuvaluan dollar
      break;
    case "TWD":
      symbolPath = "NT$"; // New Taiwan dollar
      break;
    case "TZS":
      symbolPath = "TSh"; // Tanzanian shilling
      break;
    case "UAH":
      symbolPath = "₴"; // Ukrainian hryvnia
      break;
    case "UGX":
      symbolPath = "USh"; // Ugandan shilling
      break;
    case "USD":
      symbolPath = "$"; // United States dollar
      break;
    case "UYU":
      symbolPath = "$"; // Uruguayan peso
      break;
    case "UZS":
      symbolPath = "UZS"; // Uzbekistani soʻm
      break;
    case "VES":
      symbolPath = "VES"; // Venezuelan bolívar soberano
      break;
    case "VND":
      symbolPath = "₫"; // Vietnamese đồng
      break;
    case "VUV":
      symbolPath = "VUV"; // Vanuatu vatu
      break;
    case "WST":
      symbolPath = "WST"; // Samoan tālā
      break;
    case "XAF":
      symbolPath = "FCFA"; // Central African CFA franc
      break;
    case "XCD":
      symbolPath = "$"; // Eastern Caribbean dollar
      break;
    case "XOF":
      symbolPath = "CFA"; // West African CFA franc
      break;
    case "XPF":
      symbolPath = "CFPF"; // CFP franc
      break;
    case "ZAR":
      symbolPath = "R"; // South African rand
      break;
    case "ZMW":
      symbolPath = "ZMW"; // Zambian kwacha
      break;
    case "ZWB":
      symbolPath = "ZWB"; // Zimbabwean bonds
      break;
    default:
